...
/// Store card data
@Freezed(fromJson: true, toJson: true, equal: false, addImplicitFinal: false, makeCollectionsUnmodifiable: false,)
class Card with _$Card {
  ...
  factory Card(String puzzleId) {
    return _Card(puzzleId, DateTime.now().toUtc(), DateTime.now().toUtc());
  }
